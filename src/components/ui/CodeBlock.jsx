    ...
    <div ref={ref} className="rounded-lg border border-[#3e4451] overflow-hidden my-4">
      <div className="flex items-center justify-between bg-[#21252b] px-4 py-2 border-b border-[#3e4451]">
        <div className="flex items-center gap-2 min-w-0">
          <span className="shrink-0 rounded bg-[#3e4451] px-1.5 py-0.5 text-[10px] font-mono text-[#7f848e] uppercase">{langLabel}</span>
          {fileName && <span className="text-xs text-[#abb2bf] font-mono truncate">{fileName}</span>}
        </div>
